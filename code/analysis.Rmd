...
One of the most useful things to do with this model is to test it with prices from a different time. Maybe there we could uncover different patterns of associations for different laptops. For example, perhaps high-end gaming laptops can hold their prices for a longer period of time but dropping in relative performance value as the time goes thus you would actually get a worse deal. Similarly, maybe low-end pc-s are dropping a lot after their release thus getting a better deal if you wait a little bit. It would also be interesting to see and try to fit this model on PCs or Smartphones as they share a lot of similiar properties.
