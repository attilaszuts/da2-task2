...
scatterfun <- function(x) {
  ggplot(aes(x, price_euros), data = laptop) +
    geom_point() + 
...
```{r}
scatterfun(laptop$company)
scatterfun(laptop$type_name)
scatterfun(laptop$inches)
scatterfun(laptop$screen_small)
scatterfun(laptop$screen_mid)
scatterfun(laptop$screen_big)
laptop %>% pivot_longer(cols = c("screen_small", "screen_mid", "screen_big"), names_to = "screen_category") %>% filter(value == T) %$% scatterfun(screen_category)
scatterfun(laptop$touchscreen)
scatterfun(laptop$ips)
scatterfun(laptop$resolution)
scatterfun(laptop$ram)
scatterfun(laptop$gpu_type)
scatterfun(laptop$cpu_manufac)
scatterfun(laptop$cpu_model)
scatterfun(laptop$cpu_freq)
scatterfun(laptop$memory_type)
scatterfun(laptop$ssd_size)
scatterfun(laptop$hdd_size)
scatterfun(laptop$op_sys)
